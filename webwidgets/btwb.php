...
$BTWB_SHORTCODE_WOD_PARAMS_LIST = array(
  'data-date' => false,
  'data-tracks' => BTWB_SF_WOD_TRACKS,
  'data-gym_id' => false,
  'data-sections' => BTWB_SF_WOD_SECTIONS,
  'data-type' => BTWB_SF_WOD_TYPES,
  'data-days' => 1,
  'data-leaderboard_length' => BTWB_SF_WOD_LEADERBOARD_LENGTH,
  'data-activity_length' => BTWB_SF_WOD_ACTIVITY_LENGTH
);

$BTWB_SHORTCODE_ACTIVITY_PARAMS_LIST = array(
  'data-gym_id' => false,
  'data-length' => BTWB_SF_ACTIVITY_LENGTH, 
  'data-type' => BTWB_SF_WOD_TYPES
);

$BTWB_SHORTCODE_LEADERBOARD_PARAMS_LIST = array(
  'data-workout_id' => false,
  'data-gym_id' => false,
  'data-length' => BTWB_SF_LEADERBOARD_LENGTH, 
  'data-type' => BTWB_SF_WOD_TYPES
);
...
function btwb_shortcode_wod($atts) {
  ...
  return btwb_sc_html_tag('btwb_webwidget', $BTWB_SHORTCODE_WOD_PARAMS_LIST, $atts,'Loading the WODs from Beyond the Whiteboard');
}
...
function btwb_shortcode_activity($atts) {
  ...
  return btwb_sc_html_tag('btwb_webwidget', $BTWB_SHORTCODE_ACTIVITY_PARAMS_LIST, $atts, "Loading Recent Gym Activity from Beyond the Whiteboard");
}
...
function btwb_sc_html_tag($tag_class, $params_list, $atts, $msg) {
  ...
  return "<div class='{$tag_class}' {$params}><a class='btwb_landing_page' href='http://www.beyondthewhiteboard.com/'>{$msg}</a></div>";
}
